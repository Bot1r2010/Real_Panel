    ...
    >
      <div className="relative z-10 w-[430px] rounded-3xl border border-white/10 bg-[#2d2b29]/90 p-10 shadow-2xl backdrop-blur-2xl">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-4xl font-bold text-white">ControlPoint</h1>

          <p className="mt-2 text-center text-gray-400">Вход в админ-панель</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="username" className="mb-2 block text-gray-300">
              Username
            </label>
